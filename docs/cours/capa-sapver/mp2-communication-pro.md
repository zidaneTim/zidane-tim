...
**CAPa SAPVER — 2e année**

Communiquer en situation professionnelle : accueil, transmission d'informations, posture pro.
...
-   :material-refresh:{ .lg .middle } <span class="zt-step">1</span> **Faire le bilan de ses compétences numériques et organiser son espace pro**
    ...
    Faire le point sur une année de pratique numérique et organiser une arborescence professionnelle avant la première mission de l'année.
...
-   :material-email-outline:{ .lg .middle } <span class="zt-step">2</span> **Écrire trois courriels professionnels adaptés à trois destinataires**
    ...
    Adapter le ton, la structure et les pièces jointes d'un courriel selon trois destinataires professionnels différents.
...
-   :material-magnify:{ .lg .middle } <span class="zt-step">3</span> **Construire un tableau de veille professionnelle en évaluant l'IA comme source**
    ...
    Constituer un tableau de veille sur les aides au maintien à domicile et comparer un moteur de recherche classique à un assistant conversationnel IA.
...
-   :material-clipboard-text-outline:{ .lg .middle } <span class="zt-step">4</span> **Réaliser une fiche métier composite pour un forum recrutement**
    ...
    Concevoir une fiche métier structurée à partir d'une fiche ONISEP réelle, pour un stand de recrutement en vente directe.
...
-   :material-shield-lock-outline:{ .lg .middle } <span class="zt-step">5</span> **Analyser un incident de cybersécurité en structure professionnelle**
    ...
    Approfondir en contexte professionnel les réflexes de cybersécurité de CAPa 1, à partir d'un cas réel d'incident en structure.
...
-   :material-web:{ .lg .middle } <span class="zt-step">6</span> **Modifier une page vitrine d'une structure sur un CMS simple**
    ...
    Mettre à jour une page vitrine du SAAD sur un CMS simple avant le départ en PFMP.
...
-   :material-calculator-variant-outline:{ .lg .middle } <span class="zt-step">8</span> **Construire un simulateur de caisse pour un marché de producteurs**
    ...
    Automatiser le calcul d'une commande et d'un rendu de monnaie pour tenir un stand de vente directe.
...
-   :material-calendar-check-outline:{ .lg .middle } <span class="zt-step">9</span> **Concevoir un planning d'interventions accessible**
    ...
    Construire un planning mensuel d'interventions à domicile et l'adapter en document accessible pour un public fragile.
...
-   :material-email-fast-outline:{ .lg .middle } <span class="zt-step">10</span> **Réaliser un publipostage de courriers de convocation**
    ...
    Fusionner une lettre type avec une source de destinataires pour convoquer les familles à la réunion annuelle du SAAD.
...
-   :material-tag-multiple-outline:{ .lg .middle } <span class="zt-step">11</span> **Publipostage avancé — étiquettes filtrées et bilan de trimestre**
    ...
    Filtrer une liste de destinataires pour un publipostage d'étiquettes, puis dresser son bilan CRCN de mi-année.
