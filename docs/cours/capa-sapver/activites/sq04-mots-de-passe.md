...
| Mot de passe faible | Pourquoi |
|---|---|
| `123456` · `azerty` | Les plus utilisés au monde : testés en premier. |
...
> « J'adore les crêpes au sucre le dimanche ! »
> → `Jadore2crêpes-le-Dimanche!`
