...
<p class="zt-lede">Classer des mots de passe du plus faible au plus fort, puis créer sa propre phrase de passe.</p>
...
- Être capable de **classer** des mots de passe du plus faible au plus fort.
- Être capable de **créer ma phrase de passe** personnelle solide.
...
|---|---|---|
| Classer des mots de passe | Le classement des 6 mots de passe est correct et chaque mot de passe faible est justifié par un défaut. | -- / - / + / ++ |
| Créer sa phrase de passe | La phrase de passe créée respecte les 4 règles (longueur ≥ 12, majuscule, chiffre, signe) et ne contient pas d'info personnelle évidente. | -- / - / + / ++ |
