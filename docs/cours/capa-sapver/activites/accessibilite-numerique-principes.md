...
<p class="zt-lede">Comprendre pourquoi un document doit être lisible par tous, y compris les personnes en situation de handicap.</p>
...
### Rendre un document accessible : 5 règles
...
!!! tip "Où répondre ?"
    Note tes 3 problèmes repérés et ce que les 2 aides changent dans ta trace **OneNote** de la classe (section MG1 — Vie sociale).
