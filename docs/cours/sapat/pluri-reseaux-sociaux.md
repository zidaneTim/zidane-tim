...
**Terminale Bac Pro SAPAT — module MG2**
...
-   :material-map-outline:{ .lg .middle } <span class="zt-step">1</span> **Cartographier ses propres usages des réseaux sociaux**
    ...
    Faire le point sur ses propres réseaux et usages avant de travailler la publication responsable tout au long de l'année.
...
-   :material-lock-outline:{ .lg .middle } <span class="zt-step">2</span> **Auditer et sécuriser les paramètres de confidentialité d'un compte**
    ...
    Vérifier les paramètres de confidentialité et activer la double authentification sur un compte de test.
...
-   :material-lifebuoy:{ .lg .middle } <span class="zt-step">3</span> **Identifier une situation de cyberharcèlement et les recours**
    ...
    Reconnaître les signaux d'une situation de cyberharcèlement et construire une fiche réflexes de signalement.
...
-   :material-briefcase-outline:{ .lg .middle } <span class="zt-step">4</span> **Corriger un profil professionnel fictif pour préparer sa recherche d'emploi**
    ...
    Analyser un profil professionnel fictif du point de vue d'un recruteur et proposer un plan d'amélioration.
...
-   :material-magnify:{ .lg .middle } <span class="zt-step">5</span> **Vérifier une information selon une méthode SIFT simplifiée**
    ...
    Appliquer une méthode simple de vérification pour distinguer une information fiable d'une désinformation partagée sur les réseaux.
...
-   :material-drama-masks:{ .lg .middle } <span class="zt-step">6</span> **Distinguer un contenu authentique d'un deepfake**
    ...
    Construire une grille de détection des deepfakes à partir d'une source officielle et l'appliquer à des cas concrets.
...
-   :material-circle-multiple-outline:{ .lg .middle } <span class="zt-step">7</span> **Comparer sa bulle de filtres à celle de ses camarades**
    ...
    Observer comment un algorithme personnalise un fil d'actualité et comparer les résultats entre élèves.
...
-   :material-scale-balance:{ .lg .middle } <span class="zt-step">8</span> **Décrire le cadre légal d'une publication avec des personnes identifiables**
    ...
    Construire une fiche cadre légal du droit à l'image et du RGPD, applicable à des cas de publication concrets.
...
-   :material-pencil-outline:{ .lg .middle } <span class="zt-step">9</span> **Formaliser sa méthode de publication responsable**
    ...
    Réunir les acquis du trimestre en une méthode écrite de vérification et de publication, réutilisable pour les prochaines activités.
...
-   :material-format-text:{ .lg .middle } <span class="zt-step">10</span> **Rédiger un post adapté à un public cible**
    ...
    Appliquer sa méthode de publication responsable pour réécrire un post et l'adapter à un public cible.
...
-   :material-image-outline:{ .lg .middle } <span class="zt-step">11</span> **Créer un visuel accessible pour accompagner un message**
    ...
    Concevoir un visuel accessible (contraste, texte alternatif) associé au message et au public cible travaillés la séance précédente.

    [:octicons-arrow-right-24: Ouvrir l'activité](activites/pluri-reseaux-sociaux/publier-visuel-accessible.md)
