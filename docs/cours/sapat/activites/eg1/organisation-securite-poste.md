...
### B — Vérifier la synchronisation et la sauvegarde
...
!!! tip "Astuce"
    Un dossier grisé avec une icône de nuage (et non un disque plein) signifie qu'il n'est pas encore téléchargé
    localement — normal pour OneDrive, mais à savoir avant de partir sans connexion internet.

### C — Sécuriser le poste et les partages
...
!!! tip "Astuce"
    ...
    risqué : il faut systématiquement le remplacer par un partage nominatif ou en lecture seule dès qu'il s'agit de
...
- **OneDrive (application Windows)** : gestion de la synchronisation locale — icône dans la zone de notification.
