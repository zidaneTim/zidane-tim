...
!!! info "Ton rôle aujourd'hui"
    ...
    **Si tu joues un parent Le Gall**, tiens le rôle sérieusement : tu es fatigué·e (nuits courtes), tu veux bien
    faire mais tu n'as pas le temps de tout apprendre aujourd'hui, et à l'étape C tu proposes à ton binôme d'aller
...
- Distinguer, dans un ensemble de documents, ce qui relève d'une démarche urgente et ce qui relève d'un archivage de fond
- Construire une arborescence de classement et une convention de nommage exploitables par la famille elle-même
- Comparer les avantages et les risques d'une clé USB et d'un service cloud pour la conservation de documents personnels
- Rechercher une durée légale de conservation à partir d'une source officielle, sans avancer un chiffre non vérifié
...
!!! tip "🆘 Coup de pouce"
    ...
    date du jour pour juger du délai réel qu'il reste.
...
!!! tip "⭐ Pour aller plus loin"
    ...
    petite famille. À partir de quel nombre de documents cela devient-il ingérable selon toi ?
...
!!! tip "🆘 Coup de pouce"
    ...
    dans la fiche avant de trancher.
...
!!! tip "J'explicite mes choix (2-3 min, à l'oral)"
    ...
    - Et si la famille suivante n'avait ni smartphone ni adresse mail : que changerais-tu à ton accompagnement ?

### Questions de synthèse

- Pourquoi Cybermalveillance.gouv.fr déconseille-t-il de ne compter que sur un seul support de sauvegarde ?
- Qu'est-ce qui distingue une démarche urgente d'un document à simplement archiver ?
- Pourquoi un agent d'accueil ne doit-il jamais créer un compte en ligne avec des identifiants donnés à l'oral par un usager ?
- Où trouver une durée légale de conservation plutôt que de la deviner ?
...
- **Liste des 20 documents de la famille Le Gall** (jeu de données de l'activité, à trier à l'étape B) : mail CAF
  « Prime de naissance — réponse attendue sous 15 jours », photo carte Vitale bébé, attestation de sécurité sociale
  CPAM, facture maternité 1, facture maternité 2, export PDF carnet de santé *Mon espace santé*, photo échographie
  T3, acte de naissance (copie), attestation CAF quotient familial, facture pharmacie ordonnance, photo doudou
  premier jour (souvenir, non administratif), mail mutuelle « Remboursement en attente », attestation employeur
  congé paternité, RIB transmis à la CAF, photo carnet de vaccination papier, mail crèche « Dossier d'inscription
  à compléter », facture poussette, attestation d'assurance habitation, photo livret de famille, notification
  mutuelle « Nouveau contrat disponible ».
- **Service-Public.fr — Simulateur « Combien de temps conserver ses papiers ? »** : durées minimales de
  conservation, document par document —
  [service-public.gouv.fr/simulateur/calcul/ConserverSesPapiers](https://www.service-public.gouv.fr/simulateur/calcul/ConserverSesPapiers){ target="_blank" rel="noopener" }.
- **Cybermalveillance.gouv.fr — Pourquoi et comment bien gérer ses sauvegardes ?** : comparaison clé USB / disque
  externe / cloud, règle de la sauvegarde sur plusieurs supports —
...
**Production attendue :** le tableau de tri urgent/archivage, l'arborescence et la convention de nommage
appliquées à la liste de documents, la fiche de classement au format PDF destinée à la famille Le Gall, et
l'explicitation orale de tes choix devant ton binôme ou ton enseignant.
