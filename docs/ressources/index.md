...
-   :material-incognito:{ .lg .middle } **Escape Fake**

    ---

    Escape game en ligne : démasque les fake news comme un journaliste stagiaire.

    [:octicons-arrow-right-24: Jouer](https://jeu.escape-fake.fr/)

-   :material-medical-bag:{ .lg .middle } **TousCaps**

    ---

    Jeu sérieux du ministère de l'Agriculture : les bons réflexes face à une urgence.

    [:octicons-arrow-right-24: Jouer](https://touscaps.fr/users/login)

-   :material-robot-love-outline:{ .lg .middle } **L'IA et ma citoyenneté numérique**

    ---

    Parcours Internet Sans Crainte (niveau lycée) : comprendre les algorithmes et l'IA.

    [:octicons-arrow-right-24: Découvrir le parcours](https://www.internetsanscrainte.fr/ressources/lia-et-ma-citoyennete-numerique-cycle-lycee/parcours)

-   :material-code-braces:{ .lg .middle } **Vittascience**

    ---

    Plateforme de programmation en ligne : blocs, Python, Micro:bit, Arduino…

    [:octicons-arrow-right-24: Programmer](https://fr.vittascience.com/)

-   :material-shield-key-outline:{ .lg .middle } **Concours Alkindi**

    ---

    Épreuves de cryptographie des années précédentes, en accès libre et gratuit.

    [:octicons-arrow-right-24: S'entraîner](https://epreuve.concours-alkindi.fr/)

-   :material-phone-alert-outline:{ .lg .middle } **e-Enfance / 3018**
